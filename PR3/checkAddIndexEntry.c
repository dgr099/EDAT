 ...
 */
{
    ...
    memcpy(book_id, "VAR2", 4);
    offset = 123;
    deleted = 8;
    result = addIndexEntry(book_id, 123, indexName);
    findKey(book_id, indexName, &nodeIDOrDataOffset);
    ...
    memcpy(book_id, "VAR3", 4);
    offset = 321;
    deleted = -1;
    result = addIndexEntry(book_id, offset, indexName);
    findKey(book_id, indexName, &nodeIDOrDataOffset);
