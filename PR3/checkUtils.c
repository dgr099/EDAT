...
{   Node * node;
    ...
    node = &(a[0]); book = &(b[0]);
    strcpy(book_id, "MAR2");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_zero");
    memcpy(node->book_id, book_id, PK_SIZE);
    length = strlen(title);
    ...
    node = &(a[1]); book = &(b[1]);
    strcpy(book_id, "WAR3");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_one");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[2]); book = &(b[2]);
    strcpy(book_id, "MAR0");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_two");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[3]); book = &(b[3]);
    strcpy(book_id, "VAR1");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_three");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[4]); book = &(b[4]);
    strcpy(book_id, "    ");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_four");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[5]); book = &(b[5]);
    strcpy(book_id, "BAR0");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_five");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[6]); book = &(b[6]);
    strcpy(book_id, "MAR1");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_six");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[7]); book = &(b[7]);
    strcpy(book_id, "PAR2");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_seven");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[8]); book = &(b[8]);
    strcpy(book_id, "    ");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_eigth");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[9]); book = &(b[9]);
    strcpy(book_id, "CAR5");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_nine");
    memcpy(node->book_id, book_id, PK_SIZE);
    ...
    node = &(a[10]); book = &(b[10]);
    strcpy(book_id, "RAR2");
    strcpy(title, book_id); strcat(title + PK_SIZE, "_ten");
    memcpy(node->book_id, book_id, PK_SIZE);
